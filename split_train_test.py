...
opt.im_fold = '/nfs/bigbox/hieule/penguin_data/MB_Same_Size/Train/Train_all/CROPPED/p500'
...
test_list = []
for i in test_list_short:
    test_list.append(i)
    test_list.append(i.replace('M1BS','P1BS'))
print test_list
for im in imlist:
