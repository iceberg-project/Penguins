...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='v3weakly_unetr_bs96_main_model_ignore_bad', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/pylon5/mc3bggp/aymen/checkpoints_dir/checkpoints_CVPR19W', help='models are saved here')
